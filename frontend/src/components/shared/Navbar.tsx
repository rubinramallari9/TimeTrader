          ...
          {user ? (
            <>
              ...
              <div className="relative group">
                ...
                <div className="absolute right-0 top-11 w-48 bg-[#0E1520] border border-[#1E2D40] rounded-xl shadow-2xl py-1.5 hidden group-hover:block">
                  <div className="px-4 py-2 border-b border-[#1E2D40]">
                    <p className="text-xs font-semibold text-white truncate">{user.username}</p>
                    <p className="text-[10px] text-[#9E9585] truncate">{user.email}</p>
                  </div>
                  <Link href="/profile" className="block px-4 py-2.5 text-xs text-[#9E9585] hover:text-white hover:bg-white/5 transition-colors">Profile</Link>
                  <Link href="/listings/saved" className="block px-4 py-2.5 text-xs text-[#9E9585] hover:text-white hover:bg-white/5 transition-colors">Saved Watches</Link>
